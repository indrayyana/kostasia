...
function HomeContent() {
  ...
  }, [isLogin, searchParams, pathname, router]);

  const getOffset = () => {
    if (windowWidth < 480) return 630;
    return 800;
  };
    ...
    <>
      <main className="overflow-x-hidden">
        ...
        <section className="p-4 sm:p-8 md:p-12">
          <p className="my-4 text-xl sm:text-4xl text-center font-bold bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-transparent">
            Kost ASIA
          </p>
          <p className="text-center font-semibold text-2xl mb-15">Kenapa harus Kost ASIA ?</p>

          <div className="mx-4 mb-15 sm:mx-8 lg:mx-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-12">
            <div data-aos="zoom-in" className="flex flex-col items-center text-center p-4 shadow-md rounded-lg">
              <Image
              ...
              />
              <p className="text-lg font-semibold">Lokasi Strategis</p>
              <p className="text-gray-600">Dekat dengan fasilitas umum seperti sekolah, kampus, rumah sakit, dll.</p>
            </div>
            ...
            <div data-aos="zoom-in" className="flex flex-col items-center text-center p-4 shadow-md rounded-lg">
              ...
              <p className="text-gray-600">Harga sewa yang kompetitif dengan berbagai pilihan fasilitas.</p>
            </div>
            ...
            <div data-aos="zoom-in" className="flex flex-col items-center text-center p-4 shadow-md rounded-lg">
              <Image
                ...
                className="w-40 h-40 mb-4"
              />
              <p className="text-lg font-semibold">Sewa Fleksibel</p>
              <p className="text-gray-600">Tersedia sewa harian, mingguan, atau bulanan.</p>
            </div>
          </div>
        </section>
