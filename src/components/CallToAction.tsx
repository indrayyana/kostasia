...
export default function CallToAction() {
  return (
    <section
      id="kontak"
      className="px-12 py-20 flex flex-col gap-7 justify-center items-center text-white bg-gradient-to-l from-blue-500 via-blue-700 to-blue-900"
    >
      <h2 className="text-3xl font-bold">Yuk Jangan Sampai Kehabisan</h2>
      <p>Amankan kamar pilihanmu sekarang</p>
      <Link
